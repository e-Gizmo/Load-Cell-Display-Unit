/* 
e-Gizmo Loadcell Display Unit kit Arduino Demo 
...
void setup() {
  ...
  Serial.begin(9600);
  pinMode(13,OUTPUT);
  Serial.println("e-Gizmo Weight Reader Demo");
  delay(1000);
...
void loop() {
 ...
 if(check_temperature()==true){
    ...
    */
    // Print the read data
    Serial.print("Weight: ");
    Serial.println(temp_value); //Kilogram unit
  }
...
boolean check_temperature(void){
  ...
  int  strindexe;
      ...
      // Read if Weight data is available
   ...
   return(false);  // return false if Weight data is not available
}
